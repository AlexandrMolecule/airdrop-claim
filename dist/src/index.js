...
import { claimedFailLog, claimedOkLog, claimNotStartedLog, claimStartedLog, resultsLog, scriptStartedLog, transferFailLog, transferOkLog, welcomeLog } from "./logs.js";
/* ABI */
...
class ArbClaimer {
    constructor() {
        ...
        this.claimsOk = 0;
        this.transfersOk = 0;
        this.totalAccountsDone = 0;
        this.claimStartBlock = 0;
        this.provider = new ethers.providers.JsonRpcProvider(CONFIG.rpc_arb_http);
        this.providerWss = new ethers.providers.WebSocketProvider(CONFIG.rpc_eth_wss);
    ...
    async init() {
        ...
        this.providerWss._websocket.on("close", (code) => {
            console.log(`Connection lost with code ${code}! Attempting reconnect in 1s...`);
            this.restart();
        });
...
ArbClaimer.EXPECTED_PONG_BACK = 10000;
ArbClaimer.KEEP_ALIVE_CHECK_INTERVAL = 5000;
welcomeLog();
console.log(2);
// (async () => {
